...
`@avatarsd-llc/strawberry-cli` is a framework-free TypeScript client for the Strawberry
...
This is the same package that backs the [`strawberry` CLI](./cli.md). For the wire contract see
...
|------------------|----------|-----|
| `@avatarsd-llc/strawberry-cli` | `DeviceClient`, `PushBus`, codec/transport/token seams, `commands.*` builders, the full proto vocabulary | SPA + Node |
| `@avatarsd-llc/strawberry-cli/node` | `FileTokenStore` (`0600`) + `NodeWsTransport` (`ws` fallback) + everything above | CLI, agents, Pulumi |
| `@avatarsd-llc/strawberry-cli/design` | pure, transport-free blueprint models (scaffold) | SPA tree-shake |
...
import { NodeWsTransport } from '@avatarsd-llc/strawberry-cli/node';
import { FileTokenStore } from '@avatarsd-llc/strawberry-cli/node';
import { wsUrlForHost } from '@avatarsd-llc/strawberry-cli';
...
```ts
import { DeviceClient } from '@avatarsd-llc/strawberry-cli';
...
`import { commands } from '@avatarsd-llc/strawberry-cli'` (or `import * as commands from
