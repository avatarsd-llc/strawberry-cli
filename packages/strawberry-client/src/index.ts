/**
 * `@avatarsd-llc/strawberry-client` — the shared, framework-free Strawberry client.
 *
...
// Exposed two ways: as a `commands` namespace (web-ui / Pulumi ergonomics) and as
// flat named exports (the CLI imports individual builders like growUnitSet).
